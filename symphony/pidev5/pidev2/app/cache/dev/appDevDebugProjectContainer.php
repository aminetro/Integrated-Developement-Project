...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'pidev', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Freelance\\FrontOfficeBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Freelance\\SwiftMailBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Freelance\\BackOfficeBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Freelance\\FrontOfficeBundle\\Entity');
        $c->addDriver($b, 'Freelance\\SwiftMailBundle\\Entity');
        $c->addDriver($b, 'Freelance\\BackOfficeBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('FreelanceFrontOfficeBundle' => 'Freelance\\FrontOfficeBundle\\Entity', 'FreelanceSwiftMailBundle' => 'Freelance\\SwiftMailBundle\\Entity', 'FreelanceBackOfficeBundle' => 'Freelance\\BackOfficeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fbd46d18a330307572cb39a4402a257e1f620b6d3738446ebdb29682ebcd994f');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Freelance\\FrontOfficeBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Freelance\\FrontOfficeBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Freelance\\FrontOfficeBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Freelance\\FrontOfficeBundle\\Entity\\Membre');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Freelance\\FrontOfficeBundle\\Entity\\Membre');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Freelance\FrontOfficeBundle\Redirection\AfterLoginRedirection A Freelance\FrontOfficeBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \Freelance\FrontOfficeBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Freelance\FrontOfficeBundle\Redirection\AfterLogoutRedirection A Freelance\FrontOfficeBundle\Redirection\AfterLogoutRedirection instance.
     */
    protected function getRedirect_After_LogoutService()
    {
        return $this->services['redirect.after.logout'] = new \Freelance\FrontOfficeBundle\Redirection\AfterLogoutRedirection($this->get('router'), $this->get('security.context'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Freelance/');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Freelancer/');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Jobowner/');
        ...
        $o->add($k, array(0 => 'ROLE_FREELANCER'), NULL);
        $o->add($l, array(0 => 'ROLE_JOBOWNER'), NULL);
        $o->add($m, array(0 => 'ROLE_ADMIN'), NULL);
        $o->add($n, array(0 => 'ROLE_SUPERADMIN'), NULL);

        $p = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $q = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $p, $this->get('redirect.after.logout'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($o, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $q, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $p, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('redirect.after.login'), array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $r, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '555125fc9fe80', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $o, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $p, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $p, '/login', false), '/403', NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('elusive.di.elusive@gmail.com');
        $a->setPassword('elusivedielusive');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Freelance\\FrontOfficeBundle/Resources/views'), 'FreelanceFrontOffice');
        $instance->addPath(($this->targetDirs[3].'\\src\\Freelance\\GrapheBundle/Resources/views'), 'FreelanceGraphe');
        $instance->addPath(($this->targetDirs[3].'\\src\\Freelance\\GoogleMapBundle/Resources/views'), 'FreelanceGoogleMap');
        $instance->addPath(($this->targetDirs[3].'\\src\\Freelance\\SwiftMailBundle/Resources/views'), 'FreelanceSwiftMail');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Freelance\\BackOfficeBundle/Resources/views'), 'FreelanceBackOffice');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_FREELANCER' => array(0 => 'ROLE_USER', 1 => 'ROLE_FREELANCER'), 'ROLE_JOBOWNER' => array(0 => 'ROLE_USER', 1 => 'ROLE_JOBOWNER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_JOBOWNER', 2 => 'ROLE_FREELANCER', 3 => 'ROLE_ADMIN'), 'ROLE_SUPERADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_JOBOWNER', 2 => 'ROLE_FREELANCER', 3 => 'ROLE_ADMIN', 4 => 'ROLE_SUPERADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FreelanceFrontOfficeBundle' => 'Freelance\\FrontOfficeBundle\\FreelanceFrontOfficeBundle',
                'ObHighchartsBundle' => 'Ob\\HighchartsBundle\\ObHighchartsBundle',
                'FreelanceGrapheBundle' => 'Freelance\\GrapheBundle\\FreelanceGrapheBundle',
                'FreelanceGoogleMapBundle' => 'Freelance\\GoogleMapBundle\\FreelanceGoogleMapBundle',
                'FreelanceSwiftMailBundle' => 'Freelance\\SwiftMailBundle\\FreelanceSwiftMailBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'FreelanceBackOfficeBundle' => 'Freelance\\BackOfficeBundle\\FreelanceBackOfficeBundle',
            ...
            'mailer_user' => 'elusive.di.elusive@gmail.com',
            'mailer_password' => 'elusivedielusive',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'elusive.di.elusive@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'elusivedielusive',
            ...
            'fos_user.model.user.class' => 'Freelance\\FrontOfficeBundle\\Entity\\Membre',
